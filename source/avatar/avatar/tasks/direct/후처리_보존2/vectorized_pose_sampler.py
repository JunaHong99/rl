...
class VectorizedPoseSampler:
    ...
    def sample_episodes(self, num_envs):
        ...
        while total_valid < num_envs and loop_cnt < MAX_LOOPS:
            ...
            # Allow slightly closer/further? No, keep standard reachable range
            dist_mask = (d1_start > 0.3) & (d1_start < 0.80) & \
            ...
            q_goal_1 = self.ik_solver.solve_ik_gradient(g_ee1_loc_p, g_ee1_loc_R, max_iter=200)
            q_goal_2 = self.ik_solver.solve_ik_gradient(g_ee2_loc_p, g_ee2_loc_R, max_iter=200)
