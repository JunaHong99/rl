...
class MLPActor(nn.Module):
    ...
    def __init__(
        ...
        in_dim = _state_dim(use_full_state)
    ...
    def forward(self, batch):
        s, u = _extract_state(batch, self.use_full_state)
...
class MLPQCritic(nn.Module):
    def __init__(self, action_dim: int = 6, hidden_dim: int = 256, num_hidden_layers: int = 2,
        ...
        super().__init__()
        self.use_full_state = use_full_state
        in_dim = _state_dim(use_full_state) + action_dim
...
class MLPTwinQ(nn.Module):
    def __init__(self, action_dim: int = 6, hidden_dim: int = 256, num_hidden_layers: int = 2,
                 use_full_state: bool = False):
        super().__init__()
        self.q1 = MLPQCritic(action_dim, hidden_dim, num_hidden_layers, use_full_state)
        self.q2 = MLPQCritic(action_dim, hidden_dim, num_hidden_layers, use_full_state)
